<?php
/**
 * Test Import CSV Simple - ทดสอบการแก้ไขปัญหา 500 error แบบง่าย
 */

echo "<h1>🔧 Test Import CSV Simple - ทดสอบการแก้ไขปัญหา 500 error</h1>";
...
try {
    ...
    $testFile = $uploadDir . 'test_import_simple.csv';
