...
<head>
    ...
    <title>แก้ไขบริษัท - CRM SalesTracker</title>
                ...
                <div class="card">
                    <div class="card-header">
                        <h6 class="card-title mb-0">
                            ...
                            แก้ไขข้อมูลบริษัท: <?php echo htmlspecialchars($company['company_name']); ?>
                        </h6>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="admin.php?action=companies&subaction=edit&id=<?php echo $company['company_id']; ?>">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="company_name" name="company_name" 
                                               ...
                                               required>
                                        <div class="form-text">กรอกชื่อบริษัทที่ต้องการแก้ไข</div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="company_code" name="company_code" 
                                               value="<?php echo htmlspecialchars($_POST['company_code'] ?? $company['company_code']); ?>">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="tel" class="form-control" id="phone" name="phone" 
                                               value="<?php echo htmlspecialchars($_POST['phone'] ?? $company['phone']); ?>">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="email" class="form-control" id="email" name="email" 
                                               value="<?php echo htmlspecialchars($_POST['email'] ?? $company['email']); ?>">
                                ...
                                <div class="col-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="address" name="address" rows="3"
                                                  placeholder="ที่อยู่ของบริษัท"><?php echo htmlspecialchars($_POST['address'] ?? $company['address']); ?></textarea>
                                    ...
                                    <div class="mb-3">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="is_active" name="is_active" 
                                                   value="1" <?php echo (($_POST['is_active'] ?? $company['is_active']) ? 'checked' : ''); ?>>
                                            <label class="form-check-label" for="is_active">
                                                <i class="fas fa-check-circle me-1"></i>สถานะใช้งาน
                                            </label>
                                            <div class="form-text">เปิดใช้งานบริษัทนี้</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
